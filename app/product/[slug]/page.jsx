...
const ProductPage = ({ params: { slug } }) => {
  ...
  return (
    <div className=" px-4 pt-20 flex items-center justify-center  text-red bg-cheeseCake min-h-screen">
      {loading ? (
          ...
          <div className=" space-y-5">
            ...
            <div className="grid grid-cols-2 pt-5">
              <div className=" lg:col-start-2 col-span-2">
                ...
                >
                  <button className="flex items-center justify-center font-semibold group-hover:text-red text-cheeseCake gap-5 rounded-3xl py-2 ">
